...
| `doc_list_does_not_follow_directory_symlinks` | tests/cli_doc.rs:205 | REQ-00-00-00-01 | active |
| `doc_list_emits_a_json_document_catalog` | tests/cli_doc.rs:123 | REQ-05-01-08-01 | active |
| `doc_list_filters_the_catalog_by_kind` | tests/cli_doc.rs:135 | REQ-05-01-08-03 | active |
| `doc_list_honours_configured_skip_dirs` | tests/cli_doc.rs:183 | REQ-01-01-17-01 | active |
| `doc_list_lists_each_document_once_under_overlapping_roots` | tests/cli_doc.rs:228 | REQ-05-01-08-01 | active |
| `doc_list_skips_the_default_directories_without_an_override` | tests/cli_doc.rs:263 | REQ-01-01-17-02 | active |
...
| `doc_read_distinguishes_a_document_miss_from_a_selector_miss` | tests/cli_doc.rs:157 | REQ-05-01-10-03 | active |
| `doc_read_retrieves_a_document_by_id` | tests/cli_doc.rs:145 | REQ-05-01-10-01 | active |
| `doc_search_finds_documents_by_full_text` | tests/cli_doc.rs:171 | REQ-02-01-06-01 | active |
