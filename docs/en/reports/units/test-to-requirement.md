...
| `catalogue_entries_carry_anchors_and_coverage_status` | tests/cli_publish.rs:621 | REQ-04-01-17-02 | active |
| `catalogue_pages_are_deterministic` | tests/cli_publish.rs:643 | REQ-04-01-17-03 | active |
...
| `pdf_staging_drops_the_leading_title_and_lifts_content_to_top_level` | src/publisher.rs:1003 | REQ-04-01-03-09 | active |
...
| `publish_site_stages_catalogue_pages_per_workflow_group` | tests/cli_publish.rs:596 | REQ-04-01-17-01 | active |
...
| `render_forwards_tool_errors_transparently` | tests/cli_publish.rs:482 | REQ-04-01-03-07 | active |
| `render_pdf_accepts_selected_markdown_files` | tests/cli_publish.rs:212 | REQ-04-01-03-04 | active |
| `render_pdf_drops_included_fragments_from_a_document` | tests/cli_publish.rs:346 | REQ-04-01-03-09 | active |
| `render_pdf_drops_the_index_landing_and_lifts_units_to_top_level` | tests/cli_publish.rs:394 | REQ-04-01-03-09 | active |
| `render_pdf_passes_each_document_title_as_metadata` | tests/cli_publish.rs:443 | REQ-04-01-03-09 | active |
| `render_pdf_produces_one_artefact_per_document` | tests/cli_publish.rs:307 | REQ-04-01-03-09 | active |
| `render_pdf_renders_via_pandoc` | tests/cli_publish.rs:187 | REQ-04-01-03-04 | active |
| `render_pdf_stores_artefacts_per_configured_mode` | tests/cli_publish.rs:266 | REQ-04-01-03-06 | active |
| `render_pdf_supports_defaults_eisvogel_and_package_overrides` | tests/cli_publish.rs:237 | REQ-04-01-03-05 | active |
| `render_pdf_supports_defaults_eisvogel_and_package_overrides` | tests/cli_publish.rs:238 | REQ-04-01-03-08 | active |
...
| `staged_pages_do_not_duplicate_the_title_heading` | tests/cli_publish.rs:657 | REQ-04-01-03-02 | active |
