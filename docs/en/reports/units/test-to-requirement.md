...
| `a_lone_copy_or_digest_is_reported` | src/checkers/frontmatter.rs:2124 | REQ-08-01-28-02 | active |
...
| `code_unit_lists_implements_markers_without_a_fn` | src/reporter.rs:1382 | REQ-04-01-12-04 | active |
| `complete_final_source_is_clean` | src/checkers/frontmatter.rs:2061 | REQ-08-01-28-01 | active |
| `complete_final_source_is_clean` | src/checkers/frontmatter.rs:2062 | REQ-08-01-28-02 | active |
| `complete_final_source_is_clean` | src/checkers/frontmatter.rs:2063 | REQ-08-01-28-03 | active |
...
| `doc_new_reports_taken_ids_as_tpl_004` | tests/cli_doc.rs:920 | REQ-08-01-39-01 | active |
...
| `draft_source_without_provenance_is_clean` | src/checkers/frontmatter.rs:2144 | REQ-08-01-28-02 | active |
| `empty_link_cases_stay_visible_in_the_matrix` | tests/cli_quality.rs:286 | REQ-03-01-02-04 | active |
| `escaping_or_corpus_resident_local_copy_is_reported` | src/checkers/frontmatter.rs:2188 | REQ-08-01-28-03 | active |
...
| `finalised_source_without_a_copy_is_clean` | src/checkers/frontmatter.rs:2107 | REQ-08-01-28-02 | active |
| `finalised_source_without_provenance_is_reported` | src/checkers/frontmatter.rs:2086 | REQ-08-01-28-02 | active |
| `finding_messages_match_the_oracle_formatting` | src/checkers/frontmatter.rs:1898 | REQ-01-01-11-07 | active |
...
| `fmt_lifts_claim_markers_into_derived_triples` | tests/cli_fmt.rs:152 | REQ-08-01-40-02 | active |
...
| `lines_of_code_counts_tracked_files_only` | tests/cli_report.rs:571 | REQ-07-01-09-01 | active |
...
| `lint_frontmatter_checks_derived_triples_like_declared_ones` | tests/cli_lint_frontmatter.rs:551 | REQ-08-01-40-03 | active |
| `lint_frontmatter_checks_edges_against_domain_and_range` | tests/cli_lint_frontmatter.rs:319 | REQ-08-01-36-01 | active |
| `lint_frontmatter_checks_paths_against_the_dir_template` | tests/cli_lint_frontmatter.rs:430 | REQ-08-01-38-01 | active |
...
| `lint_frontmatter_validates_claim_markers` | tests/cli_lint_frontmatter.rs:484 | REQ-08-01-40-01 | active |
...
| `malformed_provenance_values_are_reported` | src/checkers/frontmatter.rs:2161 | REQ-08-01-28-03 | active |
...
| `percent_ties_round_to_even_like_python` | src/reporter.rs:1405 | REQ-04-01-12-04 | active |
...
| `report_claims_exports_markers_and_counts_coverage` | tests/cli_report.rs:634 | REQ-08-01-41-01 | active |
| `report_claims_exports_markers_and_counts_coverage` | tests/cli_report.rs:635 | REQ-08-01-41-02 | active |
| `report_coverage_renders_the_unit_from_a_summary` | tests/cli_report.rs:514 | REQ-07-01-10-01 | active |
...
| `report_snapshot_check_detects_a_stale_statements_export` | tests/cli_report.rs:435 | REQ-07-01-08-02 | active |
...
| `report_snapshot_generates_the_lines_of_code_unit` | tests/cli_report.rs:475 | REQ-07-01-09-01 | active |
| `report_snapshot_regenerates_units_deterministically` | tests/cli_report.rs:249 | REQ-04-01-12-04 | active |
| `report_snapshot_renders_the_source_catalog` | tests/cli_report.rs:607 | REQ-08-01-37-01 | active |
| `report_statements_exports_the_classification` | tests/cli_report.rs:402 | REQ-07-01-08-01 | active |
| `retired_ids_finds_the_retired_story` | src/reporter.rs:1318 | REQ-04-01-12-04 | active |
| `scaffolded_documents_satisfy_the_default_meta_contract` | tests/cli_fmt.rs:126 | REQ-01-01-19-03 | active |
| `scoreboard_shows_full_verified_functional` | src/reporter.rs:1338 | REQ-04-01-12-04 | active |
| `search_answers_within_a_second_on_a_thousand_documents` | tests/cli_quality.rs:194 | REQ-00-00-00-11 | active |
| `selftest_cases_match_the_oracle` | src/checkers/frontmatter.rs:1676 | REQ-01-01-11-07 | active |
| `sentence_checks_match_the_oracle_selftest_cases` | src/checkers/requirements.rs:1035 | REQ-01-01-11-06 | active |
| `source_iri_outside_the_namespace_is_reported` | src/checkers/frontmatter.rs:2074 | REQ-08-01-28-01 | active |
...
| `story_progress_counts_the_verified_requirement` | src/reporter.rs:1307 | REQ-04-01-12-04 | active |
| `story_progress_excludes_retired_stories` | src/reporter.rs:1325 | REQ-04-01-12-04 | active |
| `story_without_a_workflow_is_reported` | src/checkers/requirements.rs:1437 | REQ-01-01-11-08 | active |
| `table_cells_escape_pipes` | src/reporter.rs:1399 | REQ-04-01-12-04 | active |
| `templates_and_validation_share_the_contract_source` | tests/cli_quality.rs:404 | REQ-01-01-10-03 | active |
| `test_to_requirement_lists_the_active_test` | src/reporter.rs:1349 | REQ-04-01-12-04 | active |
| `test_to_story_joins_through_the_requirement` | src/reporter.rs:1360 | REQ-04-01-12-04 | active |
| `test_to_workflow_joins_through_the_story` | src/reporter.rs:1371 | REQ-04-01-12-04 | active |
...
| `units_are_deterministic` | src/reporter.rs:1390 | REQ-04-01-12-04 | active |
