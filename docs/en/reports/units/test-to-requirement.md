...
| `a_lone_copy_or_digest_is_reported` | src/checkers/frontmatter.rs:1723 | REQ-08-01-28-02 | active |
...
| `bad_fixture_reports_kind_and_iri` | src/checkers/requirements.rs:1156 | REQ-01-01-11-06 | active |
| `breaking_releases_require_migration_notes_and_changelog_entries` | tests/corpus_guards.rs:287 | REQ-01-01-15-04 | active |
| `canonical_owner_fixture_is_clean_with_multiple_stories` | src/checkers/requirements.rs:1173 | REQ-01-01-11-06 | active |
...
| `complete_final_source_is_clean` | src/checkers/frontmatter.rs:1660 | REQ-08-01-28-01 | active |
| `complete_final_source_is_clean` | src/checkers/frontmatter.rs:1661 | REQ-08-01-28-02 | active |
| `complete_final_source_is_clean` | src/checkers/frontmatter.rs:1662 | REQ-08-01-28-03 | active |
...
| `consolidation_persona_attaches_to_any_workflow` | src/checkers/requirements.rs:1465 | REQ-01-01-11-09 | active |
| `coupled_story_is_clean_and_relevant_personas_count` | src/checkers/requirements.rs:1476 | REQ-01-01-11-08 | active |
| `coupled_story_is_clean_and_relevant_personas_count` | src/checkers/requirements.rs:1477 | REQ-01-01-11-09 | active |
...
| `cross_cutting_requirement_needs_two_distinct_stories` | src/checkers/requirements.rs:1289 | REQ-01-01-11-06 | active |
...
| `draft_source_without_provenance_is_clean` | src/checkers/frontmatter.rs:1743 | REQ-08-01-28-02 | active |
| `empty_link_cases_stay_visible_in_the_matrix` | tests/cli_quality.rs:286 | REQ-03-01-02-04 | active |
| `escaping_or_corpus_resident_local_copy_is_reported` | src/checkers/frontmatter.rs:1787 | REQ-08-01-28-03 | active |
...
| `finalised_source_without_a_copy_is_clean` | src/checkers/frontmatter.rs:1706 | REQ-08-01-28-02 | active |
| `finalised_source_without_provenance_is_reported` | src/checkers/frontmatter.rs:1685 | REQ-08-01-28-02 | active |
| `finding_messages_match_the_oracle_formatting` | src/checkers/frontmatter.rs:1498 | REQ-01-01-11-07 | active |
| `finding_messages_match_the_oracle_formatting` | src/checkers/requirements.rs:1242 | REQ-01-01-11-06 | active |
...
| `foreign_owner_fixture_reports_lnk_001` | src/checkers/requirements.rs:1191 | REQ-01-01-11-06 | active |
...
| `good_fixture_parses_clean` | src/checkers/requirements.rs:1135 | REQ-01-01-11-06 | active |
...
| `malformed_provenance_values_are_reported` | src/checkers/frontmatter.rs:1760 | REQ-08-01-28-03 | active |
...
| `missing_frontmatter_reports_id_001` | src/checkers/requirements.rs:1224 | REQ-01-01-11-06 | active |
| `missing_generated_meta_reports_meta_001` | src/checkers/requirements.rs:1209 | REQ-01-01-11-06 | active |
| `multi_clause_sentences_classify_as_complex` | src/checkers/requirements.rs:1352 | REQ-07-01-08-01 | active |
...
| `persona_missing_from_the_workflow_is_reported` | src/checkers/requirements.rs:1450 | REQ-01-01-11-09 | active |
...
| `selftest_cases_match_the_oracle` | src/checkers/frontmatter.rs:1276 | REQ-01-01-11-07 | active |
| `sentence_checks_match_the_oracle_selftest_cases` | src/checkers/requirements.rs:1032 | REQ-01-01-11-06 | active |
| `source_iri_outside_the_namespace_is_reported` | src/checkers/frontmatter.rs:1673 | REQ-08-01-28-01 | active |
| `staged_pages_do_not_duplicate_the_title_heading` | tests/cli_publish.rs:764 | REQ-04-01-03-02 | active |
| `story_in_a_workflow_its_id_does_not_encode_is_reported` | src/checkers/requirements.rs:1419 | REQ-01-01-11-08 | active |
...
| `story_without_a_workflow_is_reported` | src/checkers/requirements.rs:1434 | REQ-01-01-11-08 | active |
...
| `unresolvable_workflow_reference_skips_the_persona_check` | src/checkers/requirements.rs:1488 | REQ-01-01-11-09 | active |
