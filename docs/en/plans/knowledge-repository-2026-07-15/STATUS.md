...
- [x] D7 query surface: ADR-0023 accepted 2026-07-19 (owner decisions: structured conjunctive filters instead of a query language, doc query at the store, the MCP query tool in the same slice); REQ-02-01-06-04 on US-02-01-06 and REQ-05-01-12-04 on US-05-01-12, spec-first red/green — kind/lifecycle/edge filters with prefix targets over the declared triples including external targets, one shared function behind both surfaces.
