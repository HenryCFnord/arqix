...
- **Line splitting and frontmatter parsing** — four deliberately separate splitter contracts, not one shared splitter (REQ-00-00-00-01, ADR-0004).
  ...
  Consolidating these contracts is deliberately unplanned work: they differ in meaning, not by accident, and a shared splitter would have to serve all four meanings at once.
