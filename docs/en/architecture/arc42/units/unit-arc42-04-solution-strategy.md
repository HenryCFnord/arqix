...
3. **Contracts first, implementation second.**
   The 142 requirements, the requirements style guide, and the two Python checker scripts define testable contracts before Rust code exists; the scripts are the reference specification for the Rust port and stay as oracles.
