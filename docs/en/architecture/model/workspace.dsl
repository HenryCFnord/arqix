    ...
    model {
        ...
        arqix = softwareSystem "arqix CLI" "Deterministic documentation-as-code toolchain: create, format, lint, assemble, trace, report, publish." {
            cli = container "arqix binary" "Single Rust CLI; all commands resolve against the effective configuration (REQ-00-00-00-06)." "Rust" {
                ...
                linter = component "Linter" "Include, reference, ID-policy, lifecycle, and done-claim checks, the translation-source check, and the architecture-view derivation check that validates each embedded C4 Mermaid view against this model (REQ-01-01-04-*, REQ-01-01-18-*, REQ-03-01-09-*, REQ-00-00-00-10, REQ-04-01-18-*, ADR-0016)."
                ...
                traceEngine = component "Trace Engine" "Scans verifies/implements/plans markers, builds the trace graph, matrices, coverage with joined test outcomes, the regression ratchet, and marker freshness against git history (REQ-03-01-05-*, REQ-03-01-02-*, REQ-01-01-08-*, REQ-03-01-10-*, REQ-04-01-15/16-*, REQ-03-01-11-*, ADR-0015)."
