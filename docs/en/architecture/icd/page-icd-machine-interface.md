...
This page assembles the machine-facing interface contract of arqix — the surface a caller, CI gate, or agent programs against — from one unit per interface concern.
arc42 explains how the tool is built; this ICD fixes what it exposes and consumes.
