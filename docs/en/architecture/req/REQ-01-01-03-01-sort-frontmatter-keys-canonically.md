...
Derived from the acceptance criteria of US-01-01-03 during the group-01 pilot derivation (see `docs/en/plans/requirements-derivation-2026-07-02/PLANS.md`).
