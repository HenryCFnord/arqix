...
- a draft idea must first be turned into a repository artefact,
- that artefact must be committed before a branch can be created from it,
...
3. OpenClaw to generate draft planning artefacts on that branch,
...
- mobile-first intake
- repository artefacts created early
