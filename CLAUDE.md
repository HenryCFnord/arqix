...
- Non-normative convenience pointers:
  ...
  - Daily gate for any change: `python3 scripts/arqix verify` runs the checkers, the marker gate, an informational coverage report, and `cargo test` in one command.
