/*!
 * Vendored force-layout engine for the arqix graph explorer (ADR-0020).
 * Concatenation of the pinned upstream minified UMD builds, in load order:
 *   d3-dispatch@3.0.1  https://registry.npmjs.org/d3-dispatch/-/d3-dispatch-3.0.1.tgz
 *   d3-quadtree@3.0.1  https://registry.npmjs.org/d3-quadtree/-/d3-quadtree-3.0.1.tgz
 *   d3-timer@3.0.1     https://registry.npmjs.org/d3-timer/-/d3-timer-3.0.1.tgz
 *   d3-force@3.0.0     https://registry.npmjs.org/d3-force/-/d3-force-3.0.0.tgz
 * Copyright 2010-2021 Mike Bostock — ISC licence (see docs/en/sources/SRC-0005.md).
 * Update by deliberate re-vendoring only: refetch, reconcatenate, refresh the
 * digest in the source record.
 */
